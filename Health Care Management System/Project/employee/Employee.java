...
public class Employee {
	...
	private void initialize() {
		...
		frmHealthCareManagement.setIconImage(Toolkit.getDefaultToolkit().getImage(Employee.class.getResource("/resource/main.jpg")));
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(lblNewLabel_1, GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE))
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
											...
											.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
												.addComponent(salary, Alignment.TRAILING)
												.addComponent(time, Alignment.TRAILING)
												.addComponent(gender, Alignment.TRAILING)
												.addComponent(date, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 299, Short.MAX_VALUE)
												.addComponent(age))))))
							.addGap(18)))
					.addGap(18)
