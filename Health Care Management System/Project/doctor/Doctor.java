...
public class Doctor {
	...
	private void initialize() {
		...
		frmHealthCareManagement.setIconImage(Toolkit.getDefaultToolkit().getImage(Doctor.class.getResource("/resource/main.jpg")));
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lblNewLabel_3, GroupLayout.DEFAULT_SIZE, 459, Short.MAX_VALUE)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(name)
										.addComponent(age, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)))
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(groupLayout.createSequentialGroup()
										...
										.addComponent(lblNewLabel_5, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
										.addGroup(groupLayout.createSequentialGroup()
											.addComponent(lblNewLabel_6, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
											.addPreferredGap(ComponentPlacement.RELATED)))
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(groupLayout.createSequentialGroup()
											.addGap(18)
										...
										.addComponent(time, GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE)
										.addComponent(date, GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE)
										.addComponent(gender, GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE)
										.addComponent(salary, GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE))))
							.addGap(18)))
					.addGap(18)
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Name", "Age", "Gender", "Joining Date", "Time", "Salary"
			}
		));
